...
class PLDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        return DataLoader(self.train_dataset,shuffle=True, collate_fn=collate_fn, **self.train_loader)

    def val_dataloader(self):
        collate_fn = get_collate_fn(self.val_loader)
        return DataLoader(self.val_dataset,shuffle=False, collate_fn=collate_fn, **self.val_loader)
